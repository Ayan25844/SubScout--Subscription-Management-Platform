...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            ...
            "url": "https://github.com/Ayan25844",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Subscription_DTO"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/Update_Subscription_Status"
                        }
                    }
                ],
                "responses": {
...
var SwaggerInfo = &swag.Spec{
	...
	Description:      "A high-performance subscription tracking service built with Go and PostgreSQL.\nThis API handles user authentication, subscription lifecycle management, and expense analytics.",
